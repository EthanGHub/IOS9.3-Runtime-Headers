...
- (void)addRoadRibbonTo:(unordered_map_f54c85ed *)arg1 styleQuery:(shared_ptr_b80d91ee)arg2 painterZ:(unsigned int)arg3 numPoints:(unsigned long long)arg4 points:(Matrix_8746f91e *)arg5 startCap:(_Bool)arg6 endCap:(_Bool)arg7;
