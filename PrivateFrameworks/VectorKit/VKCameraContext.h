...
- (void)_updateForLocation:(id)arg1 routeMatch:(id)arg2 isRouteMatch:(_Bool)arg3 speedMultiplier:(double)arg4 onRoute:(_Bool)arg5 animated:(_Bool)arg6 defaultCourse:(double)arg7;
