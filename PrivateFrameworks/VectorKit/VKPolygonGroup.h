...
{
    struct shared_ptr<gss::PolygonDrawStyle> _cachedPolygonStyle;
    VKVectorTile *_tile;
    float _contentScale;
    ...
    struct MeshSet<ggl::PolygonMesh::MeshMesh, ggl::PolygonMesh::DefaultVbo> _strokeMeshInfo;
    ...
    struct FeatureAttributeSet _originalFeatureAttributes;
}
...
- (_Bool)addPointyRoofForPolygon:(CDStruct_d7f4d903 *)arg1 building:(CDStruct_957c25a5 *)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4 styleIndex:(float)arg5;
- (_Bool)canConstructPointyRoofForPolygon:(CDStruct_d7f4d903 *)arg1 building:(CDStruct_957c25a5 *)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4;
- (void)addExtrusionForPolygon:(CDStruct_d7f4d903 *)arg1 building:(CDStruct_957c25a5 *)arg2 index:(unsigned long long)arg3 ofTotal:(unsigned long long)arg4 hasNonWaterStyle:(_Bool)arg5 triangulator:(id)arg6 forRoofStyle:(int)arg7;
- (void)didFinishAddingData;
- (void)addPolygon:(CDStruct_d7f4d903 *)arg1 building:(CDStruct_957c25a5 *)arg2 index:(unsigned long long)arg3 ofTotal:(unsigned long long)arg4 hasNonWaterStyle:(_Bool)arg5 accessor:(struct ResourceAccessor *)arg6 triangulator:(id)arg7 prepareExtrusion:(_Bool)arg8 forRoofStyle:(int)arg9 scaleThreshold:(float)arg10;
- (void)willAddDataWithAccessor:(struct ResourceAccessor *)arg1;
- (void)prepareForPolygon:(CDStruct_d7f4d903 *)arg1 building:(CDStruct_957c25a5 *)arg2 hasNonWaterStyle:(_Bool)arg3 forRoofStyle:(int)arg4 scaleThreshold:(float)arg5;
