...
@property(nonatomic) unsigned char routeStencilRef; // @synthesize routeStencilRef=_routeStencilRef;
...
@property(readonly, nonatomic) unsigned char labelIntegerZoom;
@property(readonly, nonatomic) float labelZoom;
