...
@property(retain, nonatomic) AKUndoRedoViewController *undoPopoverViewController; // @synthesize undoPopoverViewController=_undoPopoverViewController;
...
@property(retain, nonatomic) UIView *attributeToolbarContainer; // @synthesize attributeToolbarContainer=_attributeToolbarContainer;
- (void).cxx_destruct;
