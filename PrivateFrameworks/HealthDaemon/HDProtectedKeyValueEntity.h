...
+ (_Bool)removeAchievementValuesForKeys:(id)arg1 category:(long long)arg2 healthDaemon:(id)arg3 error:(id *)arg4;
+ (_Bool)setAchievementValuesWithDictionary:(id)arg1 category:(long long)arg2 healthDaemon:(id)arg3 error:(id *)arg4;
