...
- (void)deleteObjectsWithUUIDs:(NSArray *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
...
- (void)deleteDataObjectsOfType:(HKObjectType *)arg1 matchingFilter:(_HKFilter *)arg2 handler:(void (^)(_Bool, unsigned long long, NSError *))arg3;
- (void)deleteDataObjects:(NSArray *)arg1 handler:(void (^)(_Bool, NSError *))arg2;
- (void)saveDataObjects:(NSArray *)arg1 transactionIdentifier:(NSUUID *)arg2 final:(_Bool)arg3 handler:(void (^)(NSUUID *, _Bool, NSError *))arg4;
