...
+ (_Bool)_insertValues:(id)arg1 forKeys:(id)arg2 modificationDates:(id)arg3 domain:(id)arg4 category:(long long)arg5 provenance:(long long)arg6 updatePolicy:(long long)arg7 healthDaemon:(id)arg8 error:(id *)arg9;
...
+ (_Bool)_insertCodableTimestampedKeyValuePairs:(id)arg1 domain:(id)arg2 category:(long long)arg3 provenance:(long long)arg4 healthDaemon:(id)arg5 error:(id *)arg6;
+ (_Bool)_insertCodableCategoryDomainDictionary:(id)arg1 provenance:(long long)arg2 healthDaemon:(id)arg3 error:(id *)arg4;
...
+ (_Bool)_insertKeysAndValues:(id)arg1 modificationDate:(id)arg2 domain:(id)arg3 category:(long long)arg4 provenance:(long long)arg5 updatePolicy:(long long)arg6 healthDaemon:(id)arg7 error:(id *)arg8;
...
+ (_Bool)removeValuesForDomain:(id)arg1 category:(long long)arg2 keys:(id)arg3 healthDaemon:(id)arg4 error:(id *)arg5;
...
+ (_Bool)enumerateValuesForDomain:(id)arg1 category:(long long)arg2 keys:(id)arg3 healthDaemon:(id)arg4 error:(id *)arg5 usingBlock:(CDUnknownBlockType)arg6;
