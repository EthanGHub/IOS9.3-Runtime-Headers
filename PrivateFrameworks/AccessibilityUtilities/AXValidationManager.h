...
- (_Bool)client:(id)arg1 validateClass:(id)arg2 hasProperty:(id)arg3 withType:(char *)arg4;
- (_Bool)client:(id)arg1 validateClass:(id)arg2 hasProperty:(id)arg3;
- (_Bool)validateClass:(id)arg1 hasProperty:(id)arg2 withType:(char *)arg3;
...
- (_Bool)client:(id)arg1 validateClass:(id)arg2 hasInstanceMethod:(id)arg3 withFullSignature:(char *)arg4;
- (_Bool)client:(id)arg1 validateClass:(id)arg2 hasInstanceMethod:(id)arg3 withFullSignature:(char *)arg4 argList:(struct __va_list_tag [1])arg5;
- (_Bool)_client:(id)arg1 validateClass:(id)arg2 hasClassMethod:(id)arg3 withFullSignature:(char *)arg4 argList:(struct __va_list_tag [1])arg5;
- (_Bool)client:(id)arg1 validateClass:(id)arg2 hasClassMethod:(id)arg3 withFullSignature:(char *)arg4;
...
- (_Bool)client:(id)arg1 validateClass:(id)arg2 hasInstanceVariable:(id)arg3 withType:(char *)arg4;
