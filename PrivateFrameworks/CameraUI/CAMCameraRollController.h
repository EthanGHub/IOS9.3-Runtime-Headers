...
@interface CAMCameraRollController : NSObject <PUPhotosDataSourceChangeObserver, PUOneUpPresentationHelperDelegate, PUOneUpPresentationHelperAssetDisplayDelegate, PLCameraPreviewWellImageChangeObserver, PUBrowsingViewModelChangeObserver, UIViewControllerPreviewingDelegate, UIViewControllerPreviewingDelegate_Private, UIInteractionProgressObserver>
{
    ...
    _Bool __shouldPauseAudioSessionUpdatesForCameraRollDismissal;
...
@property(nonatomic, setter=_setShouldPauseAudioSessionUpdatesForCameraRollDismissal:) _Bool _shouldPauseAudioSessionUpdatesForCameraRollDismissal; // @synthesize _shouldPauseAudioSessionUpdatesForCameraRollDismissal=__shouldPauseAudioSessionUpdatesForCameraRollDismissal;
...
@property(retain, nonatomic, setter=_setAudioSessionCategoryToken:) PUAudioSessionCategoryToken *_audioSessionCategoryToken; // @synthesize _audioSessionCategoryToken=__audioSessionCategoryToken;
...
@property(retain, nonatomic, setter=_setStagedDataSource:) PUPhotosDataSource *_stagedDataSource; // @synthesize _stagedDataSource=__stagedDataSource;
@property(retain, nonatomic, setter=_setPhotosDataSource:) PUPhotosDataSource *_photosDataSource; // @synthesize _photosDataSource=__photosDataSource;
...
- (void).cxx_destruct;
- (void)_updateAudioSessionPausingForceUpdateIfUnpausing:(_Bool)arg1;
