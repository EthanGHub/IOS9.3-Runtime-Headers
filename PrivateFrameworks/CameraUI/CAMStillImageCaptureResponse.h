...
@property(readonly, nonatomic, getter=isHDREV0) _Bool HDREV0; // @synthesize HDREV0=_HDREV0;
...
- (id)initWithUUID:(id)arg1 captureSession:(unsigned short)arg2 captureDate:(id)arg3 metadata:(id)arg4 burstIdentifier:(id)arg5 burstRepresentedCount:(unsigned long long)arg6 imageWellImage:(id)arg7 HDREV0:(_Bool)arg8 expectingPairedVideo:(_Bool)arg9;
