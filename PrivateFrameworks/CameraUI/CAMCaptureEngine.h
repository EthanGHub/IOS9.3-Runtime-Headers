...
- (void)captureOutput:(id)arg1 didFinishRecordingToMovieFileAtURL:(id)arg2 withDuration:(CDStruct_1b6d18a9)arg3 stillImageDisplayTime:(CDStruct_1b6d18a9)arg4 forSettings:(id)arg5 referringToMasterMovieFileAtURL:(id)arg6 isFinalReferenceMovie:(_Bool)arg7 error:(id)arg8;
