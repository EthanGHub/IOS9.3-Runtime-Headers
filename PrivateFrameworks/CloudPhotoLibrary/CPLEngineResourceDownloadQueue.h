...
- (id)_downloadTaskForLocalResource:(id)arg1 clientBundleID:(id)arg2 highPriority:(_Bool)arg3 background:(_Bool)arg4 backgroundTaskIdentifier:(unsigned long long)arg5 proposedTaskIdentifier:(id)arg6 didStartHandler:(CDUnknownBlockType)arg7 progressHandler:(CDUnknownBlockType)arg8 completionHandler:(CDUnknownBlockType)arg9;
