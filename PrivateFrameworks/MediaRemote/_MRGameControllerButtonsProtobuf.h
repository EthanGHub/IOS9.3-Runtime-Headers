...
- (id)description;
@property(nonatomic) _Bool hasButtonPause;
...
@property(nonatomic) _Bool hasButtonY;
@property(nonatomic) _Bool hasButtonX;
@property(nonatomic) _Bool hasButtonB;
@property(nonatomic) _Bool hasButtonA;
