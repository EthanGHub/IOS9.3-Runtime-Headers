...
- (_Bool)_addLanguageModelCompletionsForPartialWordRange:(struct _NSRange)arg1 language:(id)arg2 connection:(struct _PR_DB_IO *)arg3 sender:(id)arg4 encoding:(unsigned int)arg5 tagger:(id)arg6 taggerIndex:(unsigned long long)arg7 appIdentifier:(id)arg8 candidates:(id)arg9;
...
- (void *)languageModelForLanguage:(id)arg1 appIdentifier:(id)arg2 waitForResult:(_Bool)arg3;
...
- (id)_stringForTokenIDs:(const unsigned int *)arg1 tokenCount:(unsigned long long)arg2 languageModel:(void *)arg3 language:(id)arg4 connection:(struct _PR_DB_IO *)arg5 sender:(id)arg6 encoding:(unsigned int)arg7 prefix:(id)arg8 capitalized:(_Bool)arg9;
- (unsigned int)_tokenIDForString:(id)arg1 languageModel:(void *)arg2 createIfAbsent:(_Bool)arg3 terminatorTokenID:(unsigned int)arg4;
...
- (void)_addBasicGuessesForWordBuffer:(char *)arg1 length:(unsigned long long)arg2 language:(id)arg3 connection:(struct _PR_DB_IO *)arg4 sender:(id)arg5 minAutocorrectionLength:(unsigned long long)arg6 previousLetter:(unsigned short)arg7 nextLetter:(unsigned short)arg8 toGuesses:(id)arg9;
