...
- (oneway void)controlsVisibilityChanged:(_Bool)arg1 animated:(_Bool)arg2 synchronizationFence:(id)arg3;
...
@property(nonatomic) _Bool shouldStartPictureInPictureEnteringBackground;
