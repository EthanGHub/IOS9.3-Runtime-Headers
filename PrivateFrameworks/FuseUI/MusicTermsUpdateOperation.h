...
- (void).cxx_destruct;
- (void)_runRequestWithTermsCheckURL:(id)arg1 allowingAuthentication:(_Bool)arg2 returningError:(id *)arg3 termsContentText:(id *)arg4 hasAcceptedLatestTerms:(_Bool *)arg5 latestStoreTermsVersion:(unsigned long long *)arg6;
