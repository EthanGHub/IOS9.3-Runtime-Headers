...
- (void)downloadCloudPhotoLibraryAsset:(id)arg1 resourceType:(unsigned long long)arg2 highPriority:(_Bool)arg3 trackCPLDownload:(_Bool)arg4 proposedTaskIdentifier:(id)arg5 completion:(CDUnknownBlockType)arg6;
