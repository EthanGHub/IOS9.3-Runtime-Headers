...
@property(retain) NSTimer *screenBrightnessChangedTimer; // @synthesize screenBrightnessChangedTimer=_screenBrightnessChangedTimer;
...
- (void)setKeyPressClicksPrewarmed:(_Bool)arg1;
