...
- (_Bool)_setTracksWithPersistentIDs:(const long long *)arg1 count:(unsigned long long)arg2 notify:(_Bool)arg3 incrementEntityRevision:(_Bool)arg4;
...
- (_Bool)_setSwappedItemPersistentIDs:(const long long *)arg1 reloadContainedMediaTypes:(_Bool)arg2 mediaTypesToRemove:(id)arg3 mediaTypesToAdd:(id)arg4 size:(int)arg5 notify:(_Bool)arg6 incrementEntityRevision:(_Bool)arg7 usingConnection:(id)arg8;
- (_Bool)_setSwappedItemPersistentIDs:(const long long *)arg1 reloadContainedMediaTypes:(_Bool)arg2 mediaTypesToRemove:(id)arg3 mediaTypesToAdd:(id)arg4 size:(int)arg5 notify:(_Bool)arg6 incrementEntityRevision:(_Bool)arg7;
