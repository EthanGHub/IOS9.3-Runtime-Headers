...
@interface GEOVectorTile : NSObject
{
    ...
    CDStruct_209eac20 *_coastlines;
    unsigned long long _coastlinesCount;
    CDStruct_ccb8b08f *_polygons;
...
@property(readonly, nonatomic) CDStruct_495a9644 *hiResBuildingFootprints; // @synthesize hiResBuildingFootprints=_hiResBuildingFootprints;
...
@property(readonly, nonatomic) CDStruct_495a9644 *buildingFootprints; // @synthesize buildingFootprints=_buildingFootprints;
@property(readonly, nonatomic) unsigned long long polygonsCount; // @synthesize polygonsCount=_polygonsCount;
@property(readonly, nonatomic) CDStruct_ccb8b08f *polygons; // @synthesize polygons=_polygons;
@property(readonly, nonatomic) unsigned long long coastlinesCount; // @synthesize coastlinesCount=_coastlinesCount;
@property(readonly, nonatomic) CDStruct_209eac20 *coastlines; // @synthesize coastlines=_coastlines;
...
@property(readonly, nonatomic) CDStruct_209eac20 *lines; // @synthesize lines=_lines;
...
- (CDStruct_209eac20 *)multiSectionFeatureForGeoID:(unsigned long long)arg1;
...
- (void)forEachJunctionInRoad:(CDStruct_209eac20 *)arg1 visitor:(CDUnknownBlockType)arg2;
- (void)forEachEdgeInRoad:(CDStruct_209eac20 *)arg1 visitTwice:(_Bool)arg2 visitor:(CDUnknownBlockType)arg3;
...
- (_Bool)_decodeLabelTextPlacementsFromStream:(CDStruct_8bf61218 *)arg1 count:(unsigned long long)arg2 firstFeature:(CDStruct_d374d81c *)arg3 featureStride:(unsigned long long)arg4 tilePrecision:(unsigned char)arg5;
