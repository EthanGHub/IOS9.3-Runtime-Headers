...
@property(retain) NSMutableDictionary *studentsByStudentUsername; // @synthesize studentsByStudentUsername=_studentsByStudentUsername;
@property(retain) NSMutableDictionary *studentsByStudentIdentifier; // @synthesize studentsByStudentIdentifier=_studentsByStudentIdentifier;
@property(retain) NSMutableDictionary *classesByClassID; // @synthesize classesByClassID=_classesByClassID;
@property(retain) NSArray *classGroups; // @synthesize classGroups=_classGroups;
