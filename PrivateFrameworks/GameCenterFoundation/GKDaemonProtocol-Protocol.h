...
@class GKPlayerInternal, GKQuickAction, NSDictionary, NSString, NSURL;
...
- (oneway void)getServicesForPID:(int)arg1 localPlayer:(GKPlayerInternal *)arg2 reply:(void (^)(id <GKAccountService>, id <GKProfileService>, id <GKFriendService>, id <GKGameService>, id <GKGameStatService>, id <GKChallengeService>, id <GKMultiplayerService>, id <GKTurnBasedService>, id <GKUtilityService>, id <GKBulletinService>, id <GKLinkedAccountsService>, id <GKAnalyticsService>))arg3;
