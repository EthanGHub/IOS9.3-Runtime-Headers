...
+ (void)raiseReferenceToEmptyCellErrorForFunctionName:(id)arg1 rangeReference:(CDStruct_18e81ca1)arg2;
...
+ (void)raiseInvalidRangeUsageErrorForReference:(CDStruct_18e81ca1)arg1;
...
+ (void)raiseIndirectErrorForRangeReference:(CDStruct_18e81ca1)arg1 hostTableID:(struct __CFUUID *)arg2 calculationEngine:(id)arg3;
+ (id)indirectErrorForRangeReference:(CDStruct_18e81ca1)arg1 hostTableID:(struct __CFUUID *)arg2 calculationEngine:(id)arg3;
...
+ (id)invalidMergeReference:(CDStruct_18e81ca1)arg1 contextEntityID:(struct __CFUUID *)arg2;
+ (void)raiseErrorForInvalidReference:(CDStruct_18e81ca1)arg1 orString:(id)arg2 contextEntityID:(struct __CFUUID *)arg3 invalidMergeReference:(_Bool)arg4 disqualifiedFromEndCell:(_Bool)arg5;
+ (void)raiseErrorForInvalidReference:(CDStruct_18e81ca1)arg1 orString:(id)arg2 contextEntityID:(struct __CFUUID *)arg3;
