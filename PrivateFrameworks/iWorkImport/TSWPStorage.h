...
@class NSMutableString, NSObject, NSString, TSDInfoGeometry, TSSStylesheet, TSWPDocumentRoot, TSWPStorageBroadcaster;
...
- (id)storageByApplyingCustomFormat:(CDStruct_f25b4237)arg1;
...
- (long long)pFlipOrDelete:(_Bool)arg1 specialCharacterForObject:(id)arg2 range:(struct _NSRange)arg3 attributeArrayKind:(int)arg4 actionState:(struct TSWPStorageActionState *)arg5;
