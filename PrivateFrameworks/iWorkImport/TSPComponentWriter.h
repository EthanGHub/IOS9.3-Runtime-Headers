...
@class NSHashTable, NSMapTable, NSString, TSPArchiverManager, TSPComponent, TSPMutableComponentObjectUUIDMap, TSPObject;
...
- (void)writeObjects:(id)arg1 parentObject:(id)arg2 isCommandToModelReference:(_Bool)arg3 isAnalyzingExternalComponent:(_Bool)arg4 hasArchiverAccessLock:(_Bool)arg5 completion:(CDUnknownBlockType)arg6;
