...
@interface TSKAccessController : NSObject
{
    ...
    struct _TSKThreadTicketInfo _mainThreadTicketInfo;
...
- (struct _TSKThreadTicketInfo *)p_ticketInfoForCurrentThread;
- (struct _TSKThreadTicketInfo *)p_ticketInfoForTicket:(id)arg1;
- (void)p_finishReadForTicketInfo:(struct _TSKThreadTicketInfo *)arg1;
