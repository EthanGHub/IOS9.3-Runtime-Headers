...
+ (id)cacheDirectory;
+ (Class)mutableClass;
- (void)brushFullPath:(id)arg1 result:(void *)arg2 inContext:(struct CGContext *)arg3;
- (void)brushPath:(struct CGPath *)arg1 inContext:(struct CGContext *)arg2;
- (void)brushPath:(id)arg1 withScaling:(CDStruct_c3b9c2ee)arg2 inElementRange:(struct _NSRange)arg3 into:(void *)arg4 sectionIndex:(unsigned long long *)arg5 viewScale:(double)arg6 isPDF:(_Bool)arg7;
- (void)p_renderCGBrushSection:(id)arg1 sectionIndex:(unsigned long long)arg2 ontoPath:(id)arg3 withScaling:(CDStruct_c3b9c2ee)arg4 inElementRange:(struct _NSRange)arg5 into:(void *)arg6 viewScale:(double)arg7;
- (void)brushSection:(id)arg1 sectionIndex:(unsigned long long)arg2 ontoPath:(id)arg3 withScaling:(CDStruct_c3b9c2ee)arg4 inElementRange:(struct _NSRange)arg5 into:(void *)arg6 viewScale:(double)arg7 isPDF:(_Bool)arg8;
