...
- (void)p_resetFittingWidthsHeightsForRange:(struct TSUColumnRowRect)arg1;
- (void)resetAllCol;
- (void)resetAllRow;
...
- (_Bool)moveColsFrom:(struct TSUColumnRowRect)arg1 toCol:(unsigned char)arg2;
- (_Bool)moveRowsFrom:(struct TSUColumnRowRect)arg1 toRow:(unsigned short)arg2;
...
- (_Bool)resetModelCacheRange:(struct TSUColumnRowRect)arg1;
