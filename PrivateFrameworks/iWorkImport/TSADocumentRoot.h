...
@class NSArray, NSMutableDictionary, NSMutableSet, NSObject, NSSet, NSString, SFUCryptoKey, TSAAnnotationCache, TSAFunctionBrowserState, TSAShortcutController, TSCECalculationEngine, TSKCustomFormatList, TSKViewState, TSPLazyReference, TSTCustomFormatList, TSUWeakReference;
@protocol OS_dispatch_queue, TSADocumentRootDelegate;
...
- (id)makeStyleMapper;
@property(nonatomic) __weak id <TSADocumentRootDelegate> delegate;
- (void)dealloc;
