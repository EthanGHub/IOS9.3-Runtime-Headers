...
- (id)initFromArchive:(const struct UuidReferenceMapArchive *)arg1;
...
- (void)removeCellRef:(const CDStruct_78b871e1 *)arg1 dependencyTracker:(struct TSCEDependencyTracker *)arg2 forUuid:(const UUIDData_5fbc143e *)arg3;
- (void)addCellRef:(const CDStruct_78b871e1 *)arg1 dependencyTracker:(struct TSCEDependencyTracker *)arg2 forUuid:(const UUIDData_5fbc143e *)arg3;
- (id)description;
- (id)init;
