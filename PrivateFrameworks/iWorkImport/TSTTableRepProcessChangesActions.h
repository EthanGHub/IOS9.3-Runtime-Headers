...
@property(nonatomic) struct TSUColumnRowRect dirtyStrokeRange; // @synthesize dirtyStrokeRange=_dirtyStrokeRange;
@property(nonatomic) struct TSUColumnRowRect dirtyCellRange; // @synthesize dirtyCellRange=_dirtyCellRange;
