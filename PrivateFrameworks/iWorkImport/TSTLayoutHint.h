...
@property(nonatomic) struct TSUColumnRowRect cellRange; // @synthesize cellRange=mCellRange;
...
- (void)dealloc;
- (id)init;
- (id)initWithRange:(struct TSUColumnRowRect)arg1 hintId:(CDStruct_0441cfb5)arg2 partitionPosition:(unsigned int)arg3 maximumSize:(struct CGSize)arg4 effectiveSize:(struct CGSize)arg5 layout:(id)arg6 validity:(_Bool)arg7 horizontal:(_Bool)arg8;
