...
@property(nonatomic) struct TSUColumnRowRect cachedMaskSpillRange; // @synthesize cachedMaskSpillRange=_cachedMaskSpillRange;
...
@property(nonatomic) struct TSUColumnRowRect cachedMergeRange; // @synthesize cachedMergeRange=_cachedMergeRange;
