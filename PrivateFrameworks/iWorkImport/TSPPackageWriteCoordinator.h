...
@class NSHashTable, NSMutableArray, NSString, NSURL, TSPArchiverManager, TSPComponentExternalReferenceMap, TSPDataAttributesSnapshot, TSPDocumentRevision, TSPObject, TSPObjectContainer, TSPObjectContext, TSPPackageMetadata, TSPPersistedObjectUUIDMap, TSUPathSet;
...
- (id)objectContainer;
- (id)explicitComponentRootObjectForObject:(id)arg1 archiverOrNil:(id)arg2 claimingComponent:(id)arg3 isInComponentQueue:(_Bool)arg4 hasArchiverAccessLock:(_Bool)arg5;
