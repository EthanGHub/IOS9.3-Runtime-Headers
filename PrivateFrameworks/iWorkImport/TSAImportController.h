...
@class NSError, NSMutableArray, NSMutableSet, NSOperationQueue, NSString, NSURL, NSUUID, TSAUbiquitousRefreshQueue, TSKCollaborationState, TSPObjectContext, TSUProgressContext, TSUTemporaryDirectory;
