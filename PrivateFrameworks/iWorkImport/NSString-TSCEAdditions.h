...
+ (id)tsce_stringWithCellReference:(CDStruct_78b871e1)arg1 stickyBits:(unsigned char)arg2;
+ (id)tsce_stringWithCellID:(CDStruct_0441cfb5)arg1 stickyBits:(unsigned char)arg2;
...
- (CDStruct_0441cfb5)tsce_coordinateValueGettingStickyBits:(char *)arg1;
- (CDStruct_0441cfb5)tsce_coordinateValue;
