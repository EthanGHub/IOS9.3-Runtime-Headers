...
- (unsigned short)numberColumnsVisibleInCellRange:(struct TSUColumnRowRect)arg1;
- (unsigned short)numberColumnsHiddenInCellRange:(struct TSUColumnRowRect)arg1;
- (unsigned short)numberRowsVisibleInCellRange:(struct TSUColumnRowRect)arg1;
- (unsigned short)numberRowsUserHiddenInCellRange:(struct TSUColumnRowRect)arg1;
