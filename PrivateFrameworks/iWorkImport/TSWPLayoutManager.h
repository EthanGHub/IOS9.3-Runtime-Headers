...
- (void)deflateTarget:(id)arg1 intoHints:(vector_7a2e319d *)arg2 childHints:(id [2])arg3 anchoredDrawablePositions:(id *)arg4 topicNumbers:(struct TSWPTopicNumberHints *)arg5 layoutState:(void *)arg6;
