...
@property(nonatomic) struct TSUColumnRowRect prevEditingSpillingTextRange; // @synthesize prevEditingSpillingTextRange=mPrevEditingSpillingTextRange;
@property(readonly, nonatomic) struct TSUColumnRowRect editingSpillingTextRange; // @synthesize editingSpillingTextRange=mEditingSpillingTextRange;
...
- (id)dependentLayouts;
- (struct CGRect)p_computeSpillingTextFrameForEditingLayout:(id)arg1 textSize:(struct CGSize)arg2 editingSpillRange:(struct TSUColumnRowRect *)arg3;
...
- (struct TSUColumnRowRect)p_spillRangeForMaskingRichTextLayout:(id)arg1;
- (struct TSUColumnRowRect)p_spillRangeToRightForCellID:(CDStruct_0441cfb5)arg1;
- (struct TSUColumnRowRect)p_maximumSpillRangeForCellID:(CDStruct_0441cfb5)arg1;
