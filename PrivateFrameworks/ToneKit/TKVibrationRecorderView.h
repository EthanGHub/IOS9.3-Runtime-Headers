...
@property(retain, nonatomic, setter=_setTopLayoutGuide:) id <UILayoutSupport> _topLayoutGuide; // @synthesize _topLayoutGuide;
...
@property(retain, nonatomic) id <UILayoutSupport> topLayoutGuide;
- (void)dealloc;
