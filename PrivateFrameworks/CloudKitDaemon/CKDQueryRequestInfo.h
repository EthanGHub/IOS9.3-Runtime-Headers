...
@class CKDQueryOperation, CKDQueryURLRequest, NSMutableArray;
...
@property(nonatomic) __weak CKDQueryOperation *operation; // @synthesize operation=_operation;
@property(retain, nonatomic) CKDQueryURLRequest *request; // @synthesize request=_request;
- (void).cxx_destruct;
