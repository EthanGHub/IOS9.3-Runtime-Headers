...
- (_Bool)_saveZoneToServer:(id)arg1 withPCS:(struct _OpaquePCSShareProtection *)arg2 operation:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (struct _OpaquePCSShareProtection *)createSharePCSFromData:(id)arg1 logFailure:(_Bool)arg2 error:(id *)arg3;
...
- (_Bool)_zonePCSNeedsUpdate:(struct _OpaquePCSShareProtection *)arg1;
