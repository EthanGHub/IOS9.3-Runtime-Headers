...
- (void)handleJavaScriptDialogWithErrorCallback:(CDUnknownBlockType)arg1 successCallback:(CDUnknownBlockType)arg2 accept:(_Bool)arg3 promptText:(id *)arg4;
...
- (void)setTouchEmulationEnabledWithErrorCallback:(CDUnknownBlockType)arg1 successCallback:(CDUnknownBlockType)arg2 enabled:(_Bool)arg3;
- (void)setScriptExecutionDisabledWithErrorCallback:(CDUnknownBlockType)arg1 successCallback:(CDUnknownBlockType)arg2 value:(_Bool)arg3;
- (void)getScriptExecutionStatusWithErrorCallback:(CDUnknownBlockType)arg1 successCallback:(CDUnknownBlockType)arg2;
...
- (void)reloadWithErrorCallback:(CDUnknownBlockType)arg1 successCallback:(CDUnknownBlockType)arg2 ignoreCache:(_Bool *)arg3 scriptToEvaluateOnLoad:(id *)arg4;
