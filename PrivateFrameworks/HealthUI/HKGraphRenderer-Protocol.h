...
- (void)setNeedsRender;
- (void)drawText:(NSString *)arg1 atPoint:(struct CGPoint)arg2 horizontalAlignment:(long long)arg3 verticalAlignment:(long long)arg4 textColor:(UIColor *)arg5 font:(UIFont *)arg6 clipToAxis:(_Bool)arg7;
