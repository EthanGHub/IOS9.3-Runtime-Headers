...
+ (id)_chooseFileReservationForLargeDisplayableImageFileForAsset:(id)arg1 forceLarge:(_Bool)arg2 outFilePath:(id *)arg3 outImageType:(long long *)arg4 canFallbackToOriginal:(_Bool)arg5;
- (void)dealloc;
- (id)init;
