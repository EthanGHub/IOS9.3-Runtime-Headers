...
- (void)_setAdjustmentDataBlob:(id)arg1 formatIdentifier:(id)arg2 formatVersion:(id)arg3 baseVersion:(long long)arg4 editorBundleID:(id)arg5 renderedContentURL:(id)arg6 penultimateRenderedJPEGData:(id)arg7 isSubstandardRender:(_Bool)arg8 fullSizeRenderSize:(struct CGSize)arg9 useSecureMove:(_Bool)arg10 removeFileOnSuccess:(_Bool)arg11 inManagedObjectContext:(id)arg12;
- (void)setAdjustmentDataBlob:(id)arg1 formatIdentifier:(id)arg2 formatVersion:(id)arg3 baseVersion:(long long)arg4 editorBundleID:(id)arg5 renderedContentURL:(id)arg6 penultimateRenderedJPEGData:(id)arg7 isSubstandardRender:(_Bool)arg8 fullSizeRenderSize:(struct CGSize)arg9 inManagedObjectContext:(id)arg10;
...
- (id)_availableCloudResourcesForPhotosRequireUnadjusted:(_Bool)arg1;
...
- (void)generateAndUpdateThumbnailsWithPreviewImage:(id)arg1 thumbnailImage:(id)arg2 fromImageSource:(struct CGImageSource *)arg3 imageData:(id)arg4 thumbnailDataByFormatID:(struct __CFDictionary *)arg5 updateExistingLargePreview:(_Bool)arg6 forceSRGBConversion:(_Bool)arg7;
...
- (id)cplMasterChangeInLibrary:(id)arg1 forceUpdateForVideo:(_Bool)arg2 shouldGenerateDerivatives:(_Bool)arg3;
