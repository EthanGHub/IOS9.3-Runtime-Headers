...
@class CPLLibraryManager, NSDate, NSMutableDictionary, NSNumber, NSString, PFCoalescer, PLBatterySaverWatcher, PLCloudBatchDownloader, PLCloudBatchUploader, PLCloudResourceManager, PLCloudTaskManager, PLPhotoLibrary;
...
@property(readonly, nonatomic) unsigned long long numberOfPushedItems; // @synthesize numberOfPushedItems=_numberOfPushedItems;
