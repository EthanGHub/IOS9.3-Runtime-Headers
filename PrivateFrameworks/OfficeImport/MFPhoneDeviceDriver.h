...
- (int)alphaBlend:(id)arg1:(int)arg2:(int)arg3:(int)arg4:(int)arg5:(id)arg6:(int)arg7:(int)arg8:(int)arg9:(int)arg10:(unsigned char)arg11:(_Bool)arg12:(struct CGAffineTransform *)arg13:(unsigned int)arg14;
