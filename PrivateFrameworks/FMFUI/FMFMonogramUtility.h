...
+ (id)monogramImageOfDiameter:(double)arg1 forRecordID:(int)arg2 monogramStyle:(long long)arg3 tintColor:(id)arg4 customFont:(id)arg5 isPersonImage:(_Bool *)arg6;
+ (id)monogramImageOfDiameter:(double)arg1 forRecordID:(int)arg2 useTintColor:(id)arg3 useCustomFont:(_Bool)arg4 isPersonImage:(_Bool *)arg5;
