...
+ (void)resizeImageAtURL:(id)arg1 destinationURL:(id)arg2 maximumPixelCount:(long long)arg3 bakeInOrientation:(_Bool)arg4 convertToSRGB:(_Bool)arg5 completionHandler:(CDUnknownBlockType)arg6;
+ (void)resizeImageAtURL:(id)arg1 destinationURL:(id)arg2 maximumPixelCount:(long long)arg3 bakeInOrientation:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
+ (long long)terminate;
+ (long long)status;
