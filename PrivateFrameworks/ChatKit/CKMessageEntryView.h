...
+ (id)audioButtonImage;
+ (struct UIEdgeInsets)contentViewInsetsForMarginInsets:(struct UIEdgeInsets)arg1 shouldShowPhotoButton:(_Bool)arg2 shouldShowCharacterCount:(_Bool)arg3;
+ (struct UIEdgeInsets)coverViewInsetsForMarginInsets:(struct UIEdgeInsets)arg1 shouldShowPhotoButton:(_Bool)arg2 shouldShowCharacterCount:(_Bool)arg3;
+ (struct UIEdgeInsets)coverViewInsetsForMarginInsets:(struct UIEdgeInsets)arg1 shouldShowPhotoButton:(_Bool)arg2 shouldShowCharacterCount:(_Bool)arg3 shouldCenterCharacterCount:(_Bool *)arg4;
...
@property(retain, nonatomic) CKActionMenuGestureRecognizerButton *videoActionMenuGestureRecognizerButton; // @synthesize videoActionMenuGestureRecognizerButton=_videoActionMenuGestureRecognizerButton;
