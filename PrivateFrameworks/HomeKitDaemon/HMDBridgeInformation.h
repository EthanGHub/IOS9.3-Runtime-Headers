...
@property(retain, nonatomic) HAPTimer *discoveryAccessoryTimer; // @synthesize discoveryAccessoryTimer=_discoveryAccessoryTimer;
@property(retain, nonatomic) HAPTimer *disAssociatingAccessoryTimer; // @synthesize disAssociatingAccessoryTimer=_disAssociatingAccessoryTimer;
@property(retain, nonatomic) HAPTimer *associatingAccessoryTimer; // @synthesize associatingAccessoryTimer=_associatingAccessoryTimer;
