...
@class HAPTimer, HMAccessoryCategory, HMDAccessoryManager, HMDApplicationRegistry, HMDBridgeInformation, HMDCharacteristic, HMDHome, HMDRoom, HMMessageDispatcher, NSArray, NSData, NSMutableArray, NSMutableSet, NSString, NSUUID;
...
@property(retain, nonatomic) HAPTimer *systemTimeInformationTimer; // @synthesize systemTimeInformationTimer=_systemTimeInformationTimer;
...
@property(retain, nonatomic) HAPTimer *timeInformationTimer; // @synthesize timeInformationTimer=_timeInformationTimer;
...
- (void)unconfigure;
- (void)configureWithAccessory:(id)arg1 reAddServices:(_Bool)arg2 queue:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)configureWithAccessory:(id)arg1 reAddServices:(_Bool)arg2;
