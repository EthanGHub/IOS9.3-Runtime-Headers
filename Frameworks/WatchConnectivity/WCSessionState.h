...
- (id)description;
- (id)initWithReachable:(_Bool)arg1 paired:(_Bool)arg2 appInstalled:(_Bool)arg3 complicationEnabled:(_Bool)arg4 iOSDeviceNeedsFirstUnlock:(_Bool)arg5 pairingID:(id)arg6 pairedDevicesPairingIDs:(id)arg7 appInstallationID:(id)arg8;
- (id)initWithReachable:(_Bool)arg1 paired:(_Bool)arg2 appInstalled:(_Bool)arg3 complicationEnabled:(_Bool)arg4 activePairingID:(id)arg5 pairedDevicesPairingIDs:(id)arg6 appInstallationID:(id)arg7;
