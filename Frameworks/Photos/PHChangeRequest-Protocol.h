...
- (id)initWithXPCDict:(NSObject<OS_xpc_object> *)arg1 clientEntitled:(_Bool)arg2 clientName:(NSString *)arg3 clientBundleID:(NSString *)arg4 clientProcessID:(int)arg5;
