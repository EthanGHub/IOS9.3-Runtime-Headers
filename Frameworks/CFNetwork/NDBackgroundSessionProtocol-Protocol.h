...
- (void)avAssetDownloadTaskWithDownloadToken:(unsigned long long)arg1 URL:(NSURL *)arg2 destinationURL:(NSURL *)arg3 temporaryDestinationURL:(NSURL *)arg4 options:(NSDictionary *)arg5 identifier:(unsigned long long)arg6 reply:(void (^)(_Bool))arg7;
