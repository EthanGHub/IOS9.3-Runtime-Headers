...
@property(readonly, nonatomic) _Bool pageControlHidden; // @synthesize pageControlHidden=_pageControlHidden;
...
- (void)setPageControlHidden:(_Bool)arg1 scrollEnabled:(_Bool)arg2 duration:(double)arg3 delay:(double)arg4;
- (void)setPageControlHidden:(_Bool)arg1 duration:(double)arg2 delay:(double)arg3;
