...
@interface CNAvatarCardActionCell : UITableViewCell
{
    ...
    struct CGRect _actionImageFrame;
}
...
@property _Bool moreHighlighted; // @synthesize moreHighlighted=_moreHighlighted;
@property _Bool swipped; // @synthesize swipped=_swipped;
@property(nonatomic) long long mode; // @synthesize mode=_mode;
@property(nonatomic) long long context; // @synthesize context=_context;
@property(nonatomic) struct CGRect actionImageFrame; // @synthesize actionImageFrame=_actionImageFrame;
