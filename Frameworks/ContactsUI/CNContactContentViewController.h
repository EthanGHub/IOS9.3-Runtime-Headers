...
@class CNCardFaceTimeGroup, CNCardGroup, CNCardLinkedCardsGroup, CNContact, CNContactAction, CNContactAddFavoriteAction, CNContactAddLinkedCardAction, CNContactAddNewFieldAction, CNContactAddToExistingContactAction, CNContactCreateNewContactAction, CNContactFormatter, CNContactHeaderDisplayView, CNContactHeaderEditView, CNContactHeaderView, CNContactStore, CNContactSuggestionAction, CNContactToggleBlockCallerAction, CNContactUpdateExistingContactAction, CNContactView, CNContainer, CNGroup, CNMedicalIDAction, CNMutableContact, CNPolicy, CNPropertyAction, CNPropertyFaceTimeAction, CNPropertyIDSRequest, CNPropertyLinkedCardsAction, CNSiriContactContextProvider, HKHealthStore, NSArray, NSDictionary, NSLayoutConstraint, NSMapTable, NSMutableArray, NSMutableDictionary, NSString, UIView, UIViewController;
...
@property(retain) UIViewController *currentPresentedViewController; // @synthesize currentPresentedViewController=_currentPresentedViewController;
...
@property(retain, nonatomic) NSLayoutConstraint *quickActionsHeightConstraint; // @synthesize quickActionsHeightConstraint=_quickActionsHeightConstraint;
...
@property(nonatomic) _Bool allowsQuickActions; // @synthesize allowsQuickActions=_allowsQuickActions;
