...
@property(retain, nonatomic) SBSApplicationService *shortcutService; // @synthesize shortcutService=_shortcutService;
...
@property(nonatomic, getter=_gameControllerMenuButtonDelegate, setter=_setGameControllerMenuButtonDelegate:) __weak id <UIApplicationGameControllerMenuButtonDelegate> gameControllerMenuButtonDelegate; // @synthesize gameControllerMenuButtonDelegate=_gameControllerMenuButtonDelegate;
