...
#import <UIKit/UITableViewConstants-Protocol.h>
...
- (double)defaultPlainHeaderLabelYPositionForTableView:(id)arg1 headerBounds:(struct CGRect)arg2 textRect:(struct CGRect)arg3;
