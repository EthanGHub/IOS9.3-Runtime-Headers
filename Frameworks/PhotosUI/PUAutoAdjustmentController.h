...
- (void)enableAutoEnhanceOnModel:(id)arg1 baseImage:(id)arg2 valuesCalculator:(id)arg3 allowRedEye:(_Bool)arg4 animated:(_Bool)arg5 completionHandler:(CDUnknownBlockType)arg6;
