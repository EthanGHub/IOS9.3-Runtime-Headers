...
- (void)performCommitTransitionForPreviewViewController:(id)arg1 shouldSnapshot:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
...
@property(readonly, nonatomic) _Bool canPresentOneUpViewController;
