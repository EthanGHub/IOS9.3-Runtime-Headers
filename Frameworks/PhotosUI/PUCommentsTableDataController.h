...
@property(nonatomic, getter=_isBeginningToEdit, setter=_setBeginningToEdit:) _Bool _beginningToEdit; // @synthesize _beginningToEdit=__beginningToEdit;
