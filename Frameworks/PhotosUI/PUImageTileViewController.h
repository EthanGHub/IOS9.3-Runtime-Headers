...
@property(retain, nonatomic, setter=_setFullsizeTiledLayer:) PLTiledLayer *_fullsizeTiledLayer; // @synthesize _fullsizeTiledLayer=__fullsizeTiledLayer;
...
@property(retain, nonatomic, setter=_setFullsizeJPEGData:) NSData *_fullsizeJPEGData; // @synthesize _fullsizeJPEGData=__fullsizeJPEGData;
...
@property(nonatomic) _Bool shouldUseFullsizeJPEG; // @synthesize shouldUseFullsizeJPEG=_shouldUseFullsizeJPEG;
