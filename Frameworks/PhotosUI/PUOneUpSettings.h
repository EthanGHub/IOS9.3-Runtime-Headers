...
@property(nonatomic) _Bool useDebuggingBadge; // @synthesize useDebuggingBadge=_useDebuggingBadge;
...
@property(nonatomic) _Bool useLegacyOneUp; // @synthesize useLegacyOneUp=_useLegacyOneUp;
- (void).cxx_destruct;
