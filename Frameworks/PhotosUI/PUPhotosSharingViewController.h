...
@property(retain, nonatomic) id <PUPresentingPhotoBrowserController> presentingPhotoBrowserController; // @synthesize presentingPhotoBrowserController=_presentingPhotoBrowserController;
