...
@interface PUTiledLayoutGenerator : NSObject
{
    ...
    struct PUTileInfo _cachedTileInfo[20];
...
- (_Bool)scanTile:(struct PUTileInfo *)arg1 ofType:(long long)arg2;
- (_Bool)scanTile:(struct PUTileInfo *)arg1 type:(long long *)arg2;
- (_Bool)scanTileWithSquareImage:(struct PUTileInfo *)arg1;
- (_Bool)scanTileWithHorizontalPanorama:(struct PUTileInfo *)arg1;
- (_Bool)scanTileWithLandscapeImage:(struct PUTileInfo *)arg1;
- (_Bool)scanTileWithPortraitImage:(struct PUTileInfo *)arg1;
- (_Bool)scanAnyTile:(struct PUTileInfo *)arg1;
- (_Bool)scanTile:(struct PUTileInfo *)arg1 passingTest:(CDUnknownBlockType)arg2;
