...
@interface PUOneUpTilingLayout : PUSectionedTilingLayout
{
    ...
    struct {
        ...
        _Bool respondsToScrollOffsetForItemAtIndexPath;
        _Bool respondsToCanShowCommentsForItemAtIndexPath;
        _Bool respondsToShouldShowCommentsForItemAtIndexPath;
...
@property(nonatomic) _Bool useCommentsTiles; // @synthesize useCommentsTiles=_useCommentsTiles;
...
- (void)_getLayoutRect:(out struct CGRect *)arg1 transform:(out struct CGAffineTransform *)arg2 parallaxOffset:(out struct CGPoint *)arg3 shouldIncludeBottomOffset:(_Bool)arg4 forContentOfItemAtIndexPath:(id)arg5;
...
- (_Bool)_areCommentsVisibleForItemAtIndexPath:(id)arg1;
