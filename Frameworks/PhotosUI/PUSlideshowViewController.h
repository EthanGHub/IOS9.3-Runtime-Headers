...
@property(retain, nonatomic, setter=_setSlideshowPlaceHolderView:) PUPlaceholderView *_slideshowPlaceholderView; // @synthesize _slideshowPlaceholderView=__slideshowPlaceholderView;
