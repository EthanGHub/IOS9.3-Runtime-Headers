...
- (void)searchViewController:(id)arg1 displaySearchResults:(id)arg2 orAlbum:(struct NSObject *)arg3 withTitle:(id)arg4 animated:(_Bool)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)_presentSearchViewControllerAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
- (void)_searchButtonPressed:(id)arg1;
- (void)navigateToLastYearPhotosAnimated:(_Bool)arg1;
- (void)_navigateToPhotosSearchAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
- (void)navigateToPhotosSearchAnimated:(_Bool)arg1;
- (void)_presentSearchViewController:(id)arg1 forTraitCollection:(id)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
- (void)_adaptSearchViewController:(id)arg1 toTraitCollection:(id)arg2 animated:(_Bool)arg3;
- (id)searchButtonItem;
