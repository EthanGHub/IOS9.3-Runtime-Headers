...
+ (id)newSearchBar;
+ (_Bool)mustAdaptFromTraitCollection:(id)arg1 toTraitCollection:(id)arg2;
+ (_Bool)usePopoverAppearanceForTraitCollection:(id)arg1;
...
- (void)_pushMomentsGridForPhotosWithUUIDs:(id)arg1 title:(id)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)_pushMomentsGridForPhotoCollections:(id)arg1 title:(id)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
