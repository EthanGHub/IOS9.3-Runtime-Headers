...
- (void)_setHasStarted:(_Bool)arg1;
@property(nonatomic) _Bool hasStarted; // @synthesize hasStarted=_hasStarted;
- (void)_setTransitionPaused:(_Bool)arg1;
@property(nonatomic, getter=isTransitionPaused) _Bool transitionPaused; // @synthesize transitionPaused=_transitionPaused;
