...
@property(retain, nonatomic, setter=_setVideoDownloadRequest:) PUResourceDownloadRequest *_videoDownloadRequest; // @synthesize _videoDownloadRequest=__videoDownloadRequest;
@property(readonly, nonatomic) PHAsset *_videoAsset; // @synthesize _videoAsset=__videoAsset;
@property(nonatomic) __weak id <PUVideoEditViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
