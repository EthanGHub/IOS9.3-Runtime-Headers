...
@interface PUOneUpBarsController : PUBarsController <PUBrowsingViewModelChangeObserver, PUAssetActionPerformerDelegate, UIPopoverPresentationControllerDelegate, PUPlayPauseBarItemsControllerChangeObserver, PUOverOneUpPresentationSessionBarsDelegate, PUBarButtonItemCollectionDataSource, PUScrubberViewDelegate>
{
    ...
    _Bool __shouldAnimateNextChromeVisibilityUpdate;
...
@property(nonatomic, setter=_setShouldAnimateNextChromeVisibilityUpdate:) _Bool _shouldAnimateNextChromeVisibilityUpdate; // @synthesize _shouldAnimateNextChromeVisibilityUpdate=__shouldAnimateNextChromeVisibilityUpdate;
...
@property(nonatomic) _Bool isShowingPlayPauseButton; // @synthesize isShowingPlayPauseButton=_isShowingPlayPauseButton;
...
- (void)_setShowingPlayPauseButton:(_Bool)arg1;
- (void)_updateShowingPlayPauseButton;
- (void)_updateChromeVisibilityIfNeeded;
- (void)_invalidateChromeVisibilityWithAnimation:(_Bool)arg1;
