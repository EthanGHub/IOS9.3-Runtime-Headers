...
@interface WKWebView : UIView <UIScrollViewDelegate>
{
    ...
    _Bool __allowsDoubleTapGestures;
}

@property(readonly, nonatomic) _Bool _allowsDoubleTapGestures; // @synthesize _allowsDoubleTapGestures=__allowsDoubleTapGestures;
- (id).cxx_construct;
- (void).cxx_destruct;
