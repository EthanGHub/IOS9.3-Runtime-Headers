...
@class MPAVController, MPAVItem, MPClosedCaptionDisplay, MPSwipableView, MPTVOutWindow, MPVideoBackgroundView, MPVideoView, NSString, UIActivityIndicatorView, UIAlertController, UIColor, UIImage, UIView, _UIHostedWindow;
