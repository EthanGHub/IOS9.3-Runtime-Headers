...
- (void)removeItemsWithIdentifiers:(NSArray *)arg1 atFilteredIndexes:(NSIndexSet *)arg2 inPlaylistWithIdentifier:(long long)arg3 completionBlock:(void (^)(_Bool))arg4;
