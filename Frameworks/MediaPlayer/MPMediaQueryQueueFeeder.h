...
- (id).cxx_construct;
- (void).cxx_destruct;
- (unsigned long long)_playbackIndexByApplyShuffleType:(unsigned long long)arg1 withStartIndex:(unsigned long long)arg2 startIndexMediaItem:(id)arg3 shouldKeepConsistentQueueOrder:(_Bool)arg4;
