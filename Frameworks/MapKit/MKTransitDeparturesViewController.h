...
@interface MKTransitDeparturesViewController : UITableViewController <_MKTransitConnectionCellDelegate, _MKPlaceTransitIncidentCellDelegate, MKTransitDeparturesCellDelegate, GEOResourceManifestTileGroupObserver>
{
    ...
    _Bool _hasNoDisplayableDepartureInfo;
...
- (_Bool)_systemHasAllInactiveLines:(id)arg1 serviceResumesDescription:(id *)arg2;
- (_Bool)_systemHasAllInactiveLines:(id)arg1;
- (id)_inactiveLinesForSystem:(id)arg1 linesWithServiceResumesDataOnly:(_Bool)arg2;
- (_Bool)_systemHasInactiveLines:(id)arg1;
- (_Bool)_showInactiveWithDataOnly;
