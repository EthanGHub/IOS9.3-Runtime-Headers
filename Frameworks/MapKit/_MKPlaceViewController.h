...
@class CNContact, CNContactNavigationController, GEORouteGenerator, MKMapItem, MKMapItemMetadataDealRequest, MKPlaceActionsViewController, MKPlaceHeaderView, MKPlaceInfoViewController, MKPlaceNearbyAppsMetricsCoordinator, MKPlaceTransitViewController, NSArray, NSMapTable, NSMutableArray, NSString, RadiosPreferences, SKProductPageViewController, UIButton, UITapGestureRecognizer, _MKDistanceDetailProvider;
...
- (void)syncFavoritesUI:(_Bool)arg1;
