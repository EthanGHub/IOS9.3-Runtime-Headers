...
- (void)_reportAdSpaceStatusEventWithAdOpportunityIdentifier:(NSString *)arg1 adOriginIdentifier:(NSString *)arg2 durationInFeed:(double)arg3 responseTime:(double)arg4 firstMessage:(_Bool)arg5 screenfuls:(long long)arg6 errorCode:(long long)arg7;
