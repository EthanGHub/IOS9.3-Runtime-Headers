...
@class NSError, NSURL, QLDismissTrackingInformation, QLPreviewItemAVState, UIAlertView, _UIHostedWindow;
...
- (void)dismissalGestureDidUpdateInPreviewContentController:(id <QLPreviewContentControllerProtocol>)arg1 state:(long long)arg2 trackingInformation:(QLDismissTrackingInformation *)arg3;
